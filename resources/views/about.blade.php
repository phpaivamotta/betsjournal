    ...
    <div class="max-w-5xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 w-full space-y-2">
            ...
            <p class="text-sm">
                ...
                to <a href="{{ route('bets.create') }}"><span class="text-blue-500">Bets / New</span></a>. There, you can
                ...
                haven't placed any bets yet, just use our <a href="{{ route('odds-comparison') }}"><span
                        class="text-blue-500">Odds Comparison</span></a> tool to check out
            ...
            <p class="text-sm">
                ...
                You can see all of your bets and its details under <a href="{{ route('bets.index') }}"><span
                        class="text-blue-500">Bets / All</span></a>. You can also checkout the analysis of your bets
                under <a href="{{ route('bets.stats') }}"><span class="text-blue-500">Bets / Stats</span></a>, no need
                to use excel!
            </p>
        </div>
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                Our <a href="{{ route('odds-comparison') }}"><span class="text-blue-500">Odds Comparison</span></a> tool
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                Our <a href="{{ route('world-cup') }}"><span class="text-blue-500">World Cup</span></a> tool makes use
                of Oddspedia's special world cup widget/API.
                This tool allows you to get insights into the matches of this world cup! From game stats to weather and
                odds data given by several different bookies for a given match.
            </p>
        </div>
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                ...
                For this purpose, you can use our <a href="{{ route('odd-converter') }}"><span class="text-blue-500">Odd
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                If you want to quickly calculate the potential payout of a bet, you can use our <a
                    href="{{ route('payout-calculator') }}"><span class="text-blue-500">Payout Calculator</span></a>
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                ...
                <a href="{{ route('margin-calculator') }}"><span class="text-blue-500">Margin Calculator</span></a>
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                Under <a href="{{ route('bets.index') }}"><span class="text-blue-500">Bets / All</span></a> is where
        ...
        <div class="mb-6 w-full">
            ...
            <p class="text-sm">
                Under <a href="{{ route('bets.stats') }}"><span class="text-blue-500">Bets / Stats</span></a> is where
