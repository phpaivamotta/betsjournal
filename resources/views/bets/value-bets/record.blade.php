    ...
    <x-auth-card class="mb-4">
        ...
        <form method="POST" action="{{ route('bets.store') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="match" class="block mt-1 w-full" type="text" name="match" :value="old('match', request('match'))"
                    required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="bookie" class="block mt-1 w-full" type="text" name="bookie" :value="old('bookie', request('bookie'))"
                    required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="odd" class="block mt-1 w-full"
                    type="number" step="0.001" name="odd" :value="old('odd', request('odd'))" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="bet_type" class="block mt-1 w-full" type="text" name="bet_type" :value="old('bet_type', 'Money Line')"
                    required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="bet_pick" class="block mt-1 w-full" type="text" name="bet_pick" :value="old('bet_pick', request('betPick'))"
                    required />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-text-input id="sport" class="block mt-1 w-full" type="text" name="sport"
                    :value="old('sport', ucwords(str_replace('_', ' ', request('sport'))))" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="date" id="match_date"
                    ...
                    name="match_date" value="{{ old('match_date', request('date')) }}" required />
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="time" id="match_time"
                    class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                    name="match_time" value="{{ old('match_time', request('time')) }}" required />
            </div>
